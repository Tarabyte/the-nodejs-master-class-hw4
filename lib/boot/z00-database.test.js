...
module.exports = async (app, config) => {
  ...
  await test.module('Database', async () => {
    ...
    await test('Reading absent item should return null', async () => {
      const absent = await Tests.read('absent')

      assert(absent === null, 'Should return null for absent id')
    })
