...
module.exports = async (app, config) => {
  ...
  const { key, publicKey } = stripeConfig
  ...
  if (!publicKey) {
    throw new Error('Illegal stripe config. "publicKey" is required')
  }

  // provide public key to web app
  config.web.stripeApiPK = publicKey
