...
module.exports = {
  ...
  post: compose(
    ...
    await Orders.patch(order._id, { payment: payment.id })
...
`,
    ...
    const notifiedOrder = await Orders.patch(order._id, { message: message.id })
    ...
    return respond(200, { order: notifiedOrder })
  }),
}
